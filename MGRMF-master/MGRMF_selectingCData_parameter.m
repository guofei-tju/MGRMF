...
range2 = [2^-4,2^-3,2^-2,2^-1,2^0,2^1,2^2,2^3,2^4,2^5];

p_nearest_neighbors_range = [5,10,15,20,25,30,35,40,45,50];
ks = 300;Iteration_max = 10; gamma_gips = 0.5; lamda_L1s = 2^-5;lamda_L2s = 2^5; lamda_1s =2^5; lamda_2s = 2^5; p_nearest_neighbors = 15; gamma = 5;
...
%                         all_predict_results = [globa_true,globa_predict];
                   ...
                   results = cat(1,results,...
                        ...
                        save_results([dataname,'_results_test.txt'],results);  
                end
                end
